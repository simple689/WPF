	...
	public static class D3IconHelper
	{
		...
		public static BitmapFrame DynamicDataDisplayIcon
		{
			get
			{
				if (icon == null)
				{
					...
					icon = BitmapFrame.Create(currentAssembly.GetManifestResourceStream("SS2Widget.Resources.D3-icon.ico"));
				}
				return icon;
			}
		}
		...
		public static BitmapFrame DynamicDataDisplayWhiteIcon
		{
			get
			{
				...
				{
					Assembly currentAssembly = typeof(D3IconHelper).Assembly;
					whiteIcon = BitmapFrame.Create(currentAssembly.GetManifestResourceStream("SS2Widget.Resources.D3-icon-white.ico"));
				}
